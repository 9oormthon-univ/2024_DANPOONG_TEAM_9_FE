...
class APISampleBaseViewController: UIViewController, MapControllerDelegate {
    ...
    override func loadView() {
        ...
        let containerView = KMViewContainer()
        containerView.translatesAutoresizingMaskIntoConstraints = false
        self.view = containerView
        self.mapContainer = containerView

        // 부모 뷰와 동일한 크기로 제약 조건 설정
...
//        mapController!.delegate = self
        ...
        super.viewDidLoad()
         ...
         guard let mapContainer = mapContainer else {
             print("Error: mapContainer is nil in viewDidLoad")
             return
         }

         mapController = KMController(viewContainer: mapContainer)
         if mapController == nil {
             print("Error: KMController initialization failed")
         } else {
             print("KMController initialized")
         }
    }
